...
(function() {
    ...
    var addpad = function() {
        ...
        document.body.innerHTML +=
            ...
            '<input type="button" onclick="document.getElementById(\'huawei_ussd_keypad\').remove();" value="X" style=""/><span style="background-color: silver; height: 20px; padding: 5px;">Send or type</span><hr/>'+
