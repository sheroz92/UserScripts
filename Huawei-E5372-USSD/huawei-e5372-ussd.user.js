...
(function() {
    ...
    var addpad = function() {
        ...
        document.body.innerHTML +=
            ...
            '<span style="background-color: silver;">Send or type<span><input type="button" onclick="document.getElementById(\'huawei_ussd_keypad\').remove();" value="X" style="float:right;"/><hr/>'+
